...
ggplot(s, aes(fill=modalidades, y=porc, x=est2)) + 
  ...
  labs(title = "Localização dos Assentamentos Humanos Pré-Colombianos na Amazônia Legal"  )+
...
ggplot(todos, aes(fill=classificação, y=quantidade, x=x)) + 
  ...
  labs(title = "Sobreposição dos Assentamentos Humanos Pré-Colombianos na Amazônia Legal"  )+
  theme(plot.title = element_text(hjust= 0.5, size=12)) +
  xlab("")+
  ylab("Assentamentos Pré-Colombianos")  +
...
ggplot(dat, aes(fill=c1, y=q, x= c)) + 
  ...
  labs(title = "Assentamentos Pré-colombianos em áreas Sem Destinação")+
  theme(plot.title = element_text(hjust= 0.5, size=12)) +
...
ggplot(datt, aes(fill=cr, y=q, x= s)) + 
 ...
 # geom_text(aes(label=q), size = 2, hjust = 0.5, vjust = 3, position =     "stack") +
  ...
  labs(title = "Distribuiçao dos Assentamentos Pré-colombianos na Amazônia Legal")+
  theme(plot.title = element_text(hjust= 0.5, size=12)) +
 # theme(axis.text.x=element_text(size=rel(1.5), angle=90))+
  xlab("Camadas do Uso da terra")+
  ylab("Quantidade de Assentamentos")
...
ggplot(pos1, aes(fill=modalidade, y=quantidade, x= modalidade)) + 
  ...
  labs(title = "Assentamentos Pré-colombianos em Terras Índigenas")+
  theme(plot.title = element_text(hjust= 0.5, size=12)) +
  theme(axis.text.x=element_text(size=rel(1), angle=90))+
  xlab("")+
  ylab("Quantidade de Assentamentos ")
