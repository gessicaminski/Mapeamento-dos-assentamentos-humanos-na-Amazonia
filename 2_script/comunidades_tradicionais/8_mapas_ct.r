...
end <- readOGR(dsn = '.' , layer = 'com_tradicionais_ibge', encoding = "UTF-8")
...
plot(aml)
#plot(end, add=T, pch=20, cex=0.5,col="gray38", border = NA)
...
plot(end, add=T, pch=21,cex=0.7,col="black", bg="gray60")
...
#plot(end, add=T, pch=20,cex=0.5, col="cyan2", border = NA)
